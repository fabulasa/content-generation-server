...
@app.post("/create-captioned-semantic-videos-v2/")
async def create_captioned_semantic_video_v2(request: CaptionedVideoRequest):
    try:
        print("Received request:")
        print(f"Background Video URL: {request.background_video_url}")
        print(f"Captions: {request.captions}")
        ...
        # Submit video processing task to the executor
        executor.submit(create_captioned_semantic_video_v2, background_video_path, captions, output_video_path)
...
def create_captioned_semantic_video_v2(background_video_path, captions, output_video_path):
    try:
        # Load background video
        background_video = VideoFileClip(background_video_path)  # Load full video
